...
const nav = [
  ...
  { to: '/watch-pool', label: '观察池', icon: Binoculars },
  { to: '/portfolio',  label: '持仓',   icon: BriefcaseBusiness },
  { to: '/daily-review', label: '每日复盘', icon: ClipboardCheck },
              ...
              {({ isActive }) => (
                <>
                  ...
                  {!navCollapsed && version && (
                    <span
                      className="ml-auto font-mono text-[10px] text-muted/50 select-none shrink-0"
