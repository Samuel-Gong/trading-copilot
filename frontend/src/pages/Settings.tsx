...
import { BarChart3, CircleDollarSign, Clock3, Database, Network, PanelLeftClose, PanelLeftOpen, Radio, SlidersHorizontal, Sparkles, Settings2, Zap } from 'lucide-react'
...
import { SettingsAnalysisAgentsPanel } from './settings/AnalysisAgents'
import { SettingsTradeFeePanel } from './settings/TradeFee'
...
const TABS: readonly TabDef[] = [
  ...
  { key: 'analysis-agents', label: '分析 Agent', icon: Network, panel: SettingsAnalysisAgentsPanel },
  ...
  { key: 'trade-fee',  label: '交易费率',   icon: CircleDollarSign, panel: SettingsTradeFeePanel },
