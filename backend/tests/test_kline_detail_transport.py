...
class _DetailRepo:
    ...
    def latest_minute_dates(self, symbol, days=10, *, asset_type="stock"):
        return [_TRADE_DATE]
    ...
    def get_minute_by_dates(self, symbols, trade_dates, asset_type="stock") -> pl.DataFrame:
        return self.minute
...
def test_custom_minute_source_remains_available_without_tickflow_capability(monkeypatch):
    ...
    monkeypatch.setattr("app.data_providers.custom.lease_provider",
        lambda _: nullcontext((provider, 1)))
